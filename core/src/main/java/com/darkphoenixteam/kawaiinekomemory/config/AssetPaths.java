 ...
 * CORREGIDO: Se agregaron variables faltantes (Sliders, Logros, SFX)
 */
public final class AssetPaths {
    ...
    // === SLIDERS (Faltaban estos) ===
    // ⚠️ Verifica que estos nombres coincidan con tus archivos en assets/images/ui/sliders/
    ...
    // Renombrado de CLICK a BUTTON para coincidir con tu código:
